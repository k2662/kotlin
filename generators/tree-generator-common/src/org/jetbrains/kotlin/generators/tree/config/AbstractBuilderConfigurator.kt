...
abstract class AbstractBuilderConfigurator<Element, Implementation, BuilderField, ElementField>(
     ...
     *
     * @param name The name of the intermediate builder class to configure.
     ...
     * methods.
     */
    protected fun builder(name: String? = null, config: IntermediateBuilderConfigurationContext.() -> Unit): IntermediateBuilderDelegateProvider {
        return IntermediateBuilderDelegateProvider(name, config)
    }
