...
private class ExtTestDataFile(
    ...
    private fun doCreateTestCase(
        ...
        val testCase = TestCase(
            ...
            extras = WithTestRunnerExtras(
                ...
                inputDataFile = inputOutputDataFile(testDataFileContents, INPUT_DATA_FILE.name, "in")
            ),
        )
        testCase.initialize(
    ...
    private fun inputOutputDataFile(testDataFileContents: String, directiveName: String, fileExtension: String): File? {
