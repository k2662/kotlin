...
import static org.jetbrains.kotlin.cli.jvm.compiler.intellijCore.PluginDescriptorLoaderKt.loadForCoreEnv;
...
public class CoreApplicationEnvironment {
    ...
    public static void registerExtensionPointAndExtensions(@NotNull Path pluginRoot, @NotNull String fileName, @NotNull ExtensionsArea area) {
        IdeaPluginDescriptorImpl descriptor = loadForCoreEnv(pluginRoot, fileName);
        if (descriptor == null) {
